...
--USE ogmocedesenv
CREATE PROCEDURE SP_CRIAR_ASSIDUIDADE @P_DATA DATE , @P_DATAFIM DATE, @P_MATRICULA INT
AS
		...
		BEGIN
			...
			BEGIN
				...
				ELSE IF @P_COUNT_TEMREQ = 0 AND @P_COUNT_SEMAGULHADA > 0
					UPDATE ASSIDUIDADE SET OBSERVACAO = 'DISPONIVEL', SITUACAO = NULL WHERE MATRICULA = @MATRICULA AND PAREDE = @P_PAREDE AND DATA = @P_DATA;
